...
void nodes_layout::setDesignSizeNoBorder(const cocos2d::Size& designSize)
{
    ...
    CCLOG("x: %f; y: %f; scale: %f", scaleX, scaleY, adjustedScale);

    pEGLView->setDesignResolutionSize(nodes_layout::designSize.width * adjustedScale,
        nodes_layout::designSize.height * adjustedScale, kResolutionNoBorder);
}
...
Size nodes_layout::getNodeGroupScaledSize(const std::vector<Node*>& nodes)
{
    ...
    auto scale = nodes_utility::getScale2D(nodes[0]);
    ...
    for (size_t index = 1; index < nodes.size(); ++index) {
        ...
        scale = nodes_utility::getScale2D(child);
...
float nodes_layout::vscr::getNodeRight(Node* pNode)
{
    cocos2d::Point ptLocal(nodes_layout::getNodeLeft(pNode) + pNode->getContentSize().width, 0);
    auto ptWorld = pNode->getParent()->convertToWorldSpace(ptLocal);

    auto visibleRect = VisibleRect::getVisibleRect();
    return visibleRect.size.width - ptWorld.x;
}
float nodes_layout::vscr::getNodeTop(Node* pNode)
{
    cocos2d::Point ptLocal(0, nodes_layout::getNodeBottom(pNode) + pNode->getContentSize().height);
    auto ptWorld = pNode->getParent()->convertToWorldSpace(ptLocal);
    auto visibleRect = VisibleRect::getVisibleRect();
...
void nodes_layout::vscr::setNodeLeft(Node* pNode, float left)
{
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(0, scrSize.height) - VisibleRect::leftTop();
...
void nodes_layout::vscr::setNodeTop(Node* pNode, float top)
{
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(0, scrSize.height) - VisibleRect::leftTop();
...
void nodes_layout::vscr::setNodeRight(Node* pNode, float right)
{
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(scrSize.width, 0) - VisibleRect::rightBottom();
    Size size = pNode->getContentSize() * nodes_utility::getScale2D(pNode);
    cocos2d::Point achorPoint = Vec2::ZERO;
    if (!pNode->isIgnoreAnchorPointForPosition())
    {
...
void nodes_layout::vscr::setNodeBottom(Node* pNode, float bottom)
{
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(scrSize.width, 0) - VisibleRect::rightBottom();
...
void nodes_layout::vscr::setNodeLT(Node* pNode, const cocos2d::Point& p)
{
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(0, scrSize.height) - VisibleRect::leftTop();
...
void nodes_layout::vscr::setNodeRT(Node* pNode, const cocos2d::Point& p)
{ // right top
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
...
void nodes_layout::vscr::setNodeLB(Node* pNode, const cocos2d::Point& p)
{ // left bottom
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(0, 0) - VisibleRect::leftBottom();
    Size size = pNode->getContentSize() * nodes_utility::getScale2D(pNode);
    cocos2d::Point achorPoint = Vec2::ZERO;
    if (!pNode->isIgnoreAnchorPointForPosition())
    {
...
void nodes_layout::vscr::setNodeRB(Node* pNode, const cocos2d::Point& p)
{ // right bottom
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(scrSize.width, 0) - VisibleRect::rightBottom();
...
/// ratio position
void nodes_layout::vscr::setNodeNormalizedLT(Node* pNode, const cocos2d::Point& ratio)
{
    CC_ASSERT(pNode);
    ...
    cocos2d::Size vscrSize = VisibleRect::size();
...
void nodes_layout::vscr::setNodeNormalizedRT(Node* pNode, const cocos2d::Point& ratio)
{ // right top
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(scrSize.width, scrSize.height) - VisibleRect::rightTop();
...
void nodes_layout::vscr::setNodeNormalizedLB(Node* pNode, const cocos2d::Point& ratio)
{ // left bottom
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(0, 0) - VisibleRect::leftBottom();
...
void nodes_layout::vscr::setNodeNormalizedRB(Node* pNode, const cocos2d::Point& ratio)
{ // right bottom
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(scrSize.width, 0) - VisibleRect::rightBottom();
...
void nodes_layout::vscr::setNodeNormalizedTop(Node* pNode, const float ratioTop)
{ // right top
    CC_ASSERT(pNode);
    cocos2d::Size scrSize = Director::getInstance()->getOpenGLView()->getDesignResolutionSize();
    cocos2d::Point delta = cocos2d::Vec2(scrSize.width, scrSize.height) - VisibleRect::rightTop();
...
void nodes_layout::vscr::setNodeNormalizedPositionX(cocos2d::Node* pNode, float ratio)
{
    CC_ASSERT(pNode);
    cocos2d::Rect visibleRect = purelib::VisibleRect::getVisibleRect();
    cocos2d::Point ptWorld(visibleRect.size.width * ratio + visibleRect.origin.x, 0);
    auto ptLocal = pNode->getParent()->convertToNodeSpace(ptWorld);
    pNode->setPositionX(ptLocal.x);
}

void nodes_layout::vscr::setNodeNormalizedPositionY(cocos2d::Node* pNode, float ratio)
{
    CC_ASSERT(pNode);
    cocos2d::Rect visibleRect = purelib::VisibleRect::getVisibleRect();
...
void nodes_layout::vscr::setNodeNormalizedPosition(Node* pNode, const cocos2d::Point& ratio)
{
    CC_ASSERT(pNode);
