...
#define isIgnoreXY(align) (align == ALIGN_CENTER)
    ...
    */
    ...
    static void centerNodeX(Node* pNode)
    {
        ...
        {
            nodes_layout::centerNodeX(pNode, pNodeParent->getContentSize() *nodes_utility::getScale2D(pNodeParent));
        }
    }
    ...
    static void centerNodeY(Node* pNode)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::centerNodeY(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent));
        }
    }
    ...
    static void centerNode(Node* pNode)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::centerNode(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent));
        }
    }
    ...
    static void setNodeLeft(Node* pNode, float left, float anchor = 0.0f)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            setNodeLeft(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), left, anchor);
        }
    }
    ...
    static float getNodeLeft(Node* pNode, float anchor = 0.0f)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            return getNodeLeft(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), anchor);
        }
        return 0.0f;
    }
    ...
    static void setNodeTop(Node* pNode, float top, float anchor = 0.0f)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::setNodeTop(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), top, anchor);
        }
    }
    ...
    static float getNodeTop(Node* pNode, float anchor = 0.0f)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            return getNodeTop(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), anchor);
        }
        return 0.0f;
    }
    ...
    static void setNodeRight(Node* pNode, float right)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::setNodeRight(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), right);
        }
    }
    static float getNodeRight(Node* pNode, float anchor = 0.0f)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            return getNodeRight(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), anchor);
        }
        return 0.0f;
    }
    ...
    static void setNodeBottom(Node* pNode, float bottom, float anchor = .0f)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::setNodeBottom(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), bottom, anchor);
        }
    }
    ...
    static float getNodeBottom(Node* pNode, float anchor = 0.0f)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            return getNodeBottom(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), anchor);
        }
        return 0.0f;
    }
    ...
    { // left bottom
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::setNodeLB(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), p);
        }
    }
    ...
    { // right bottom
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::setNodeRB(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), p);
        }
    }
    ...
    { // left top
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::setNodeLT(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), p);
        }
    }
    ...
    { // right top
        ...
        if(_IsNotNull(pNodeParent))
        {
            nodes_layout::setNodeRT(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), p);
        }
    }
    ...
    static void setNodeNormalizedPositionX(cocos2d::Node* pNode, float ratio)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            setNodeNormalizedPositionX(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), ratio);
        }
    }
    ...
    static void setNodeNormalizedPositionY(cocos2d::Node* pNode, float ratio)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            setNodeNormalizedPositionY(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), ratio);
        }
    }
    static void setNodeNormalizedPosition(Node* pNode, const cocos2d::Point& ratio)
    {
        ...
        if(_IsNotNull(pNodeParent))
        {
            setNodeNormalizedPosition(pNode, pNodeParent->getContentSize() * nodes_utility::getScale2D(pNodeParent), ratio);
        }
    }
