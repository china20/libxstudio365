#ifndef _INS_WXAPIOBJECTS_H_
#define _INS_WXAPIOBJECTS_H_
#include <vector>
#include <string>
 ...
 */
struct INSWxSendMessageToWXReq : public INSWxBaseReq
{
    /** 发送消息的文本内容
 ...
 */
struct INSWxSendMessageToWXResp : public INSWxBaseResp {
};
 ...
 */
struct INSWxGetMessageFromWXReq :  public INSWxBaseReq {
};
 ...
 */
struct INSWxGetMessageFromWXResp :  public INSWxBaseResp {
    /** 向微信终端提供的文本内容
     * @attention 文本长度必须大于0且小于10K
     */
    std::string text;
 ...
 */
struct INSWxShowMessageFromWXReq :  public INSWxBaseReq{
 ...
 * 第三方程序处理完内容后调用sendResp向微信终端发送ShowMessageFromWXResp。
 */
struct INSWxShowMessageFromWXResp : INSWxBaseResp {
};
 ...
 */
struct INSWxLaunchFromWXReq : INSWxBaseReq{
};
 ...
 */
class INSWxMediaMessage  : public Ref{
    
public:
    static INSWxMediaMessage* message();
 ...
 * @see WXMediaMessage
 */
class INSWxImageObject : public Ref{
public:
    /*! @brief 返回一个WXImageObject对象
     *
     * @note 返回的WXImageObject对象是自动释放的
     */
    static INSWxImageObject* object();
 ...
 * @see WXMediaMessage
 */
class INSWxMusicObject  : public CCObject{
public:
    /*! @brief 返回一个WXMusicObject对象
     *
     * @note 返回的WXMusicObject对象是自动释放的
     */
    static INSWxMusicObject* object();
 ...
 * @see WXMediaMessage
 */
class INSWxVideoObject  : public CCObject{
public:
    static INSWxVideoObject* object();
 ...
 * @see WXMediaMessage
 */
class INSWxWebpageObject : public CCObject {
public:
    /*! @brief 返回一个WXWebpageObject对象
     *
     * @note 返回的WXWebpageObject对象是自动释放的
     */
    static INSWxWebpageObject* object(void);
 ...
 * @see WXMediaMessage
 */
class INSWxAppExtendObject : public CCObject {
public:
    /*! @brief 返回一个WXAppExtendObject对象
     *
     * @note 返回的WXAppExtendObject对象是自动释放的
     */
    static INSWxAppExtendObject* object(void);
 ...
 * @see WXMediaMessage
 */
class INSWxEmoticonObject : public CCObject {
public:
     ...
     */
    static INSWxEmoticonObject* object();
 ...
 *
 * @see INSWxMediaMessage
 */
class INSWxFileObject : public CCObject {
public:
     ...
     */
    static INSWxFileObject * object(void);
...
class INSWxApiDelegate {
    
public:
    virtual void onResp(const INSWxBaseResp& ) = 0;
    virtual void onReq(const INSWxBaseReq& ) = 0;
};
