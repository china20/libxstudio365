...
@implementation INSPaymentImpl_objc

static INSPaymentImpl_objc *s_sharedStore;
...
+ (INSPaymentImpl_objc *)sharedStore
{
    if (!s_sharedStore)
    {
        s_sharedStore = [[INSPaymentImpl_objc alloc] init];
    }
...
- (INSPaymentTransaction *)createPaymentTransaction:(SKPaymentTransaction *)transaction
{
    ...
    {
        INSPaymentTransaction* originalTransaction = [self createPaymentTransaction:transaction.originalTransaction];
        return INSPaymentTransaction::transactionWithState(transaction
,
                                                               ccstate,
                                                               ccid,
                                                               ccproductId,
