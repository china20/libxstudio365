...
#include "impl/ios/wx/NXWxApiObject.h"

USING_NS_CC;
namespace ol {

typedef std::function<void(const NXWxBaseResp&)> WxRespCallback;
typedef std::function<void(const NXWxBaseReq&)>  WxReqCallback;
